...
export default function Workout() {
  ...
  return (
    ...
    >
      ...
      <Text style={{ color: "#9A9A9A", fontSize: 16, marginBottom: 24 }}>
      ...
      >
        <Text style={{ color: "#00FFB2", fontSize: 18, fontWeight: "bold", marginBottom: 8 }}>
          Weekly Progress
        </Text>
        ...
        <Text style={{ color: "#9A9A9A", fontSize: 15, marginBottom: 16 }}>
        ...
        return (
          <View
            ...
            style={{
              ...
              borderRadius: 24,
              borderWidth: 1,
              borderColor: isCompleted ? "#00FFB2" : "#262626",
              marginBottom: 20,
            }}
          >
            <Text style={{ color: "#00FFB2", fontSize: 16, fontWeight: "bold", marginBottom: 8 }}>
              {workout.day}
            </Text>
            ...
            {isCompleted && (
              <Text style={{ color: "#00FFB2", fontSize: 14, fontWeight: "bold", marginBottom: 16 }}>
                Completed
              </Text>
            )}
            ...
            {workout.exercises.map((exercise) => (
              ...
              >
                <Text style={{ color: "white", fontSize: 17, fontWeight: "600", marginBottom: 6 }}>
                  {exercise.name}
                </Text>
            ...
            <Pressable
              onPress={() => toggleWorkout(workout.day)}
              style={{
                backgroundColor: isCompleted ? "#151515" : "#00FFB2",
                borderWidth: 1,
                borderColor: "#00FFB2",
                paddingVertical: 16,
                borderRadius: 16,
